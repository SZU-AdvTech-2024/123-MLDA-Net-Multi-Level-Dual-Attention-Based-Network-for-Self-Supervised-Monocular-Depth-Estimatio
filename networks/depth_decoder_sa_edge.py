...
class DepthDecoderAttention_edge(nn.Layer):
    def __init__(self, num_ch_enc, scales=range(4), num_output_channels=1, use_skips=True):
        ...
        # self.convs[("edge", 4)] = GridAttentionBlock(in_channels=512)
        # self.convs[("edge", 3)] = GridAttentionBlock(in_channels=256)
        # self.convs[("edge", 2)] = GridAttentionBlock(in_channels=128)
        # self.convs[("edge", 1)] = GridAttentionBlock(in_channels=64)
        # self.convs[("edge", 0)] = GridAttentionBlock(in_channels=32)
